 ...
 * @author James
 */
public class GovHack3 extends JFrame {
    ...
    public static StructuredDataMessage getSDM1(String region1,String region2,String industry) {
        try {
            ...
            or2.setDimensionValue(Collections.singletonList(new DimensionValueType("MEASURE", "IVA")));
            ors.add(or2);
            dw.setOr(ors);
    ...
    public static void saveJPEG(String region1,String region2,String industry, OutputStream out) throws Exception {
        ...
        try {
            ...
            Logger.getLogger(GovHack3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
