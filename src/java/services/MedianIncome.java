...
public class MedianIncome {
    ...
    public static CategoryDataset createDataset(String left, String right, String industry, String anzsco) {
        ...
        defaultcategorydataset.addValue(leftRD.getMedianIncomel(), s, s2);
        defaultcategorydataset.addValue(rightRD.getMedianIncomel(), s1, s2);
        return defaultcategorydataset;
    }

    public static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createBarChart("Median Income", "Region", "Income", categorydataset, PlotOrientation.VERTICAL, true, true, false);
        ...
        GradientPaint gradientpaint = new GradientPaint(0.0F, 0.0F, Color.red, 0.0F, 0.0F, Color.lightGray);
        GradientPaint gradientpaint1 = new GradientPaint(0.0F, 0.0F, Color.yellow, 0.0F, 0.0F, Color.lightGray);
