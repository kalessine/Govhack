...
public class NumBusMvmt {
    ...
    public static CategoryDataset createDataset(String left, String right, String industry, String anzsco) {
        ...
        defaultcategorydataset.addValue(leftRD.getNumBus1315Mvmt(), s, s2);
        defaultcategorydataset.addValue(rightRD.getNumBus1315Mvmt(), s1, s2);
        return defaultcategorydataset;
    }

    public static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createBarChart("Number of Business Movement 2013-15", "Region", "Change", categorydataset, PlotOrientation.VERTICAL, true, true, false);
