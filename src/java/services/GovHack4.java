 ...
 * @author James
 */
public class GovHack4 extends JFrame {
    ...
    public static StructuredDataMessage getSDM1(String region1,String region2,String industry) {
        try {
            ...
            or2.setDimensionValue(Collections.singletonList(new DimensionValueType("MEASURE", "FTE")));
            ors.add(or2);
            dw.setOr(ors);
    ...
    public static void saveJPEG(String region1,String region2,String industry, OutputStream out) throws Exception {
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("Full Time Employment", "Employees", "Time", getDataSet(region1,region2, sdm));
        ...
        try {
            ...
            Logger.getLogger(GovHack4.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
