 ...
 * @author Owner
 */
public class NewBusinessIncrease {
    ...
    public static CategoryDataset createDataset(String left, String right, String industry, String anzsco) {
        ...
        defaultcategorydataset.addValue(leftRD.getNewBusinessIncrease(), s, s2);
        defaultcategorydataset.addValue(rightRD.getNewBusinessIncrease(), s1, s2);
