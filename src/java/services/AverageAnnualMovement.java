 ...
 * @author Owner
 */
public class AverageAnnualMovement {
    ...
    public static CategoryDataset createDataset(String left, String right, String industry, String anzsco) {
        ...
        defaultcategorydataset.addValue(leftRD.getAverageAnnualMovement(), s, s2);
        defaultcategorydataset.addValue(rightRD.getAverageAnnualMovement(), s1, s2);
        return defaultcategorydataset;
    }

    public static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createBarChart("Average Annual Movement", "Region", "Rate", categorydataset, PlotOrientation.VERTICAL, true, true, false);
